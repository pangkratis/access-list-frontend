...
module.exports = function (/* ctx */) {
  return {
    ...
    pwa: {
      ...
      manifest: {
        name: 'access list management system',
        short_name: 'access list management system',
        description: 'access list management system for admins',
        display: 'standalone',
    ...
    electron: {
      ...
      builder: {
        ...
        appId: 'access-control-list-frontend'
      },
